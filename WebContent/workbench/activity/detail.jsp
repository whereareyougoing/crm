			...
			$.ajax({
				...
				success : function(data){
					...
					/*
						...
						data
							{"success":true/false,"ar":{备注}}
							{"success":true/false,"notenContent":"?","editTime":"?","editBy":"?"}
			...
			success : function(data){
				...
				*/
				...
				$.each(data,function(i,n){
					...
					//href="javascript:void(0);":表示将超链接的href禁用，该a标签只能使用js来触发事件
		...
		$.ajax({
			...
			success : function(data){
				...
				if(data.success){
					...
					//删除成功之后，刷新备注列表？ 不行！！！会在原有的div下追加信息
					//showRemark();
					
					//找到删除的记录对应的div，然后将div移除掉
					$("#"+id).remove();
