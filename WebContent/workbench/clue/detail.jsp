				...
				*/
				...
				$.each(data,function(i,n){
					...
					/*
						...
						为了解除关联方便，我们可以将n（市场活动的对象）中的id，处理成为关联关系表的id
							（就像是将owner(原有的是id)，处理成为name名字一样）
					*/
...
<body>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="toBundModalBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
