...
<script type="text/javascript">
	...
	*/
		...
		$.ajax({
			...
			success : function(data){
				...
				/*
					...
					data
						{"success":true/false,"stage":?,"possibility":?,"editBy":?,"editTime":?}
				*/
	...
	function changeIcon(stage,idx){
		...
		//准备好前面正常的阶段和后面丢失阶段的分界点
		var point = "<%=point%>";
		
		//如果当前阶段的可能性为0 前七个黑圈，后两个一个是红叉，一个是黑叉
		...
		//如果当前阶段的可能性不为0	前七个 绿圈，绿色标记，黑圈   后两个黑叉
		}else{
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//处理展现阶段图标的业务
			//展现所有的阶段（来自于数据字典dvList），为每一个阶段来赋予相应的图标及图标颜色
			
			//当前阶段的可能性为0   前7个一定是黑圈  后两个一个是红叉一个是黑叉
			...
			//如果当前阶段的可能性不为0	前7个阶段有可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
			}else{
