	...
	$(function(){
		...
		$("#create-customerName").typeahead({
			source: function (query, process) {
				$.get(
					"workbench/transaction/getCustomerNameList.do",	//发出请求的目的是为了根据文本框中输入的关键字，模糊查询该关键字相关的信息列表 
					{ "name" : query }, 
					function (data) {
			...
			delay: 500	//延迟加载，单位是毫秒，在1500毫秒后，加载出来显示数据
		});
		...
		$("#create-stage").change(function(){
			...
			//根据阶段和可能性对应的关系，来取得可能性
			//key:stage
			//关系：pMap(java中的键值对关系)--->json(js中的键值对关系)
			//json的取值分成两种
			/*
				
				json.key取得value值，应对一般情况
				
				还有一种key为一个动态的变量（key是不确定的）
				json[key]取得value值
			...
			*/
			...
			//最后将可能性在  可能性对应的文本框中赋值 
			$("#create-possibility").val(possibility);
			
		})
		
		//为保存按钮绑定事件，以提交表单的形式发出传统请求
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="1a6e789f018e470cada5f0f0a279cfa0"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="9c2fda9384324232a8bc77ea9eb4e8c9"/>
			</div>
		</div>
